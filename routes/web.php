...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::post('/admin/edit/{id?}', ['as' => 'edit', 'uses' => 'AdminController@getEdit']);
    ...
    Route::post('/admin/delete/{id?}', ['as' => 'deleteQuestion', 'uses' => 'AdminController@getDelete']);
    Route::post('/admin/delete/{id?}', ['as' => 'deleteQuestion', 'uses' => 'AdminController@postDelete']);
    Route::post('/admin/status/{id?}/{status?}', ['as' => 'status', 'uses' => 'AdminController@getStatus']);
    Route::post('/admin/theme/add', ['as' => 'addTheme', 'uses' => 'ThemeController@getAdd']);
    Route::post('/admin/theme/add', ['uses' => 'ThemeController@postAdd']);
    Route::post('/admin/theme/delete/{id?}', ['as' => 'deleteTheme', 'uses' => 'ThemeController@getDelete']);
    Route::post('/admin/theme/delete/{id?}', ['uses' => 'ThemeController@postDelete']);
    Route::post('/admin/theme/change/{id?}', ['as' => 'changeTheme', 'uses' => 'ThemeController@getChange']);
    ...
    Route::post('/admin/users/add', ['as' => 'addUser', 'uses' => 'UserController@getAdd']);
    Route::post('/admin/users/add', ['uses' => 'UserController@postAdd']);
    Route::post('/admin/users/delete/{id?}', ['as' => 'deleteUser', 'uses' => 'UserController@getDelete']);
    Route::post('/admin/users/delete/{id?}', ['uses' => 'UserController@postDelete']);
    Route::post('/admin/users/change/{id?}', ['as' => 'changeUser', 'uses' => 'UserController@getChange']);
